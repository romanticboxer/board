...
<div align="center">
	...
	<table border="1" width="500" height="300">
		...
		<tr>
			...
			<input type = "button" value = "답글달기" onclick = "location.href = 'write_board.re?num=${dto.num }&re_step=${dto.re_step }&re_level=${dto.re_level }'">
			&nbsp &nbsp &nbsp &nbsp
			<input type="button" value="글수정" onclick="location.href = 'updateForm.board?num=${dto.num}'">
			&nbsp &nbsp &nbsp &nbsp
				<input type="button" value="글삭제"
				onclick="location.href = 'deleteForm.board?num=${dto.num}'"> 
				&nbsp &nbsp &nbsp &nbsp<input
				type="button" value="글목록" onclick="location.href = 'list_reboard.re'">
	</table>
</div>
